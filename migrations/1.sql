...
('https://onenature.sujal-workspace.workers.dev/logo.png', 'Dog', 'Sheeba', 3, 'Female', 1, 'Fully Vaccinated', 'NIH Blocks A, B, C', 'Approachable', 'Manipal Campus', 'Samyak Pandey (PhD Scholar)', 'Mallika Vohra (Student, MCODS)'),
